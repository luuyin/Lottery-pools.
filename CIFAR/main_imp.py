...
def main():
    ...
    args.save_dir = "/scratch-shared/sliu/LTH_models/"+str(args.prune_type) + '/' + str(args.dataset) + '/' + str(args.arch)+'/' + "rewind_epoch_"+str(args.rewind_epoch)  + '/seed' + str(args.seed)
